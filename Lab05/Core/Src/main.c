...
int main(void)
{
  ...
  {
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, dutyCycle); // Red
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, dutyCycle); // Green
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, dutyCycle); // Blue
